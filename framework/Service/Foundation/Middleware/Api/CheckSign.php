...
namespace Framework\Service\Foundation\Middleware\Api;
...
use Framework\Service\Exception\ApiSignException;
...
class CheckSign {
    ...
    protected function checkSign($objRequest) {
        ...
        //3.签名校验
        if ($strSignKey == Des::md5($strParam, Config::get('des.md5_key.' . $strFromDomain))) {
            return true;
        }
        return false;
    }
